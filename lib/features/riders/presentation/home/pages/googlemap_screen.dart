...
class GoogleMapRiderScreen extends StatefulWidget {
  const GoogleMapRiderScreen({Key? key}) : super(key: key);

  @override
  State<GoogleMapRiderScreen> createState() => _GoogleMapRiderScreenState();
}

class _GoogleMapRiderScreenState extends State<GoogleMapRiderScreen> {
