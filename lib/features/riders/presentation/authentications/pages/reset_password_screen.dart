...
class ResetRisderPassword extends StatefulWidget {
  @override
  _ResetRisderPasswordState createState() => _ResetRisderPasswordState();
}

class _ResetRisderPasswordState extends State<ResetRisderPassword> {
              ...
              containerNavigator(
                  ...
                  ontap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => OtpCodeRiderScreen(),
                        ));
                  }),
            ],
          ),
