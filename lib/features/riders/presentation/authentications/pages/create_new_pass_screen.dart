...
class CreateNewPasswordRider extends StatefulWidget {
  @override
  _CreateNewPasswordRiderState createState() => _CreateNewPasswordRiderState();
}

class _CreateNewPasswordRiderState extends State<CreateNewPasswordRider> {
  @override
