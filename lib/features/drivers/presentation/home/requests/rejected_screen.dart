...
class RegectedScreen extends StatefulWidget {
  @override
  State<RegectedScreen> createState() => _RegectedScreenState();
}

class _RegectedScreenState extends State<RegectedScreen> {
  @override
