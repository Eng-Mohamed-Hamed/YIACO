...
class OtpCodeDriverScreen extends StatefulWidget {
  @override
  _OtpCodeDriverScreenState createState() => _OtpCodeDriverScreenState();
}

class _OtpCodeDriverScreenState extends State<OtpCodeDriverScreen> {
          ...
          child: Column(
            children: [
              ...
              containerNavigator(title: 'Continue', ontap: () {
                Navigator.pushNamed(context, Routes.createNewPasswordDriverScreen);
